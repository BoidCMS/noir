...
function noir_recent_posts(): array {
  ...
  $posts = array_slice( $posts, $offset, $per_page, true );
  return $App->get_filter( $posts, 'recent_posts', $pagination, $per_page );
}
...
function noir_post_excerpt( ?string $post = null ): string {
  ...
  $excerpt = substr( strip_tags( $excerpt ), 0, $max );
...
function noir_admin_script(): string {
  global $App, $page;
  if ( 'noir' !== $page ) return '';
  $script = $App->theme( 'admin.js', false );
    ...
    case 'noir':
      ...
      foreach ( noir_config( 'menu', false ) as $i => $item ) {
        ...
        <li id="item_' . $i . '">
          ...
          <p class="ss-small ss-gray ss-mb-5">The text that will be displayed on the menu item in the navigation menu.</p>
          <input type="text" name="menu[' . $i . '][link]" value="' . $App->esc( $item[ 'link' ] ) . '" class="ss-input" required>
          <p class="ss-small ss-gray ss-mb-5">The URL that the menu item will link to when clicked.</p>
      ...
      $layout[ 'content' ] .= '
        ...
        <fieldset id="author" class="ss-fieldset ss-mb-7 ss-mobile ss-w-6 ss-mx-auto">
          ...
          <p class="ss-small ss-gray ss-mb-5">The public name of the site author.</p>
          ...
          <p class="ss-small ss-gray ss-mb-5">This is the author\'s specific link, for example, the <b>About Me</b> or <b>Contact Me</b> page.</p>
        </fieldset>
        <fieldset id="text" class="ss-fieldset ss-mb-7 ss-mobile ss-w-6 ss-mx-auto">
          ...
          <p class="ss-small ss-gray ss-mb-5">This field allows you to replace the site title in the header with custom text or HTML. It can be useful when the title is too long, or you simply want to display different text in its place.</p>
          ...
          <p class="ss-small ss-gray ss-mb-5">This field allows for a custom text to be added to the blog title format, which will be displayed alongside the site title.</p>
          ...
          <p class="ss-small ss-gray ss-mb-5">This field allows you to customize the text that appears in place of the default "Recent Posts" text on the blog page.</p>
          ...
          <p class="ss-small ss-gray ss-mb-5">This field allows you to set a custom text to replace the default "By" text that is displayed in the posts list and in the "post.php" custom template.</p>
          ...
          <p class="ss-small ss-gray ss-mb-5">This field allows you to replace the default "Read more &rarr;" text that appears on the blog\'s post list.</p>
          ...
          <p class="ss-small ss-gray ss-mb-5">This is the text that replaces the default "Proudly powered by" text in the footer of every page.</p>
        </fieldset>
        ...
        <p class="ss-small ss-gray ss-mb-5">The maximum number of posts to display on a single page.<br>This determines how many posts visitors will see at once before they need to navigate to the next page.</p>
        ...
        <p class="ss-small ss-gray ss-mb-5">The maximum number of characters used to generate post excerpts.</p>
        ...
        <p class="ss-small ss-gray ss-mb-5">Character to use as a title separator in the "&lt;title&gt;" tag.</p>
        ...
        <p class="ss-small ss-gray ss-mb-5">Display "<a href="#proudly_powered_by">Proudly powered by</a>" text which indicates that your site is built using BoidCMS.<br>This text will be displayed in the footer of every page.</p>
